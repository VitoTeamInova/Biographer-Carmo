        ...
        <div className="flex flex-col md:flex-row-reverse gap-8 items-center">
          <div className="md:w-1/2">
            <div className="relative overflow-hidden rounded-lg shadow-lg transition-transform duration-500 hover:scale-[1.02] group">
              <img 
                src={data.educationPhoto} 
                alt={`${data.firstName} ${data.lastName} - Educação`} 
          ...
          <div className="md:w-1/2">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md border-l-4 border-amber-400">
              <div className="flex items-center mb-4">
                <GraduationCap className="h-8 w-8 text-indigo-700 mr-3" />
                <h3 className="text-xl font-serif font-bold text-indigo-900">Formação Acadêmica</h3>
              </div>
              
              <p className="text-gray-700 leading-relaxed">
                {data.educationText.split('\n').map((paragraph, index) => (
